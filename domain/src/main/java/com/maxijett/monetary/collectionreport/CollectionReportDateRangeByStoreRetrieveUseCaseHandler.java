...
public class CollectionReportDateRangeByStoreRetrieveUseCaseHandler implements UseCaseHandler<List<CollectionReport>, CollectionReportByDateBetweenAndStoreRetrieve> {
    ...
    @Override
    public List<CollectionReport> handle(CollectionReportByDateBetweenAndStoreRetrieve useCase) {
